...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            CheckForRainChange();
            UpdateWind();
            audioSourceRainLight.Update(MaxRainVolume);
            audioSourceRainMedium.Update(MaxRainVolume);
            audioSourceRainHeavy.Update(MaxRainVolume);
        }
    ...
    public class LoopingAudioSource
    {
        ...
        public void Update(float maxVolume = 1)
        {
            if (AudioSource.isPlaying && (AudioSource.volume = Mathf.Lerp(AudioSource.volume, maxVolume, Time.deltaTime)) == 0.0f)
            {
                AudioSource.Stop();
            }
        }
