...
namespace WeaponSystem
{
    ...
    public class WeaponData : ScriptableObject
    {
        ...
        public int maxAmmoCapacity = 500;
        public float NoiseCausedRange = 45;

        [Header("Accuracy & Recoil")]
        public float MinimumSpreadFactor = 1;
        public float MaximumSpreadFactor = 1;
        public float adsSpreadReduceFactor = 1.5f;
        public float SpreadFactorIncreasingRate = 1;
        [Space]
        public float recoilForce = 2f;
        public float baseRecoil = 2f;
        ...
        public Vector3 secondAdsPosition = new Vector3(0f, -0.05f, 0.2f);
        public Vector3 secondAdsRotation = Vector3.zero;
